...
namespace ColbyO.VNTG.ColorPalette.Editor
{
    ...
    {
        [MenuItem("Assets/Create/VNTG/Convert Tex to Palette Asset", false, 20)]
        private static void ConvertSelectedTextureToPalette()
        {
            ...
            LUTBaker.BakePaletteTo3DLUT(paletteColors, paletteAsset.distanceMetric, ref paletteAsset.RawLUT, ref paletteAsset.LUT);
        ...
        [MenuItem("Assets/Create/VNTG/Convert Tex to Palette Asset", true)]
